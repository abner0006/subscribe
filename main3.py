...
others_file = "output/source/source4.txt"

# NEW 将合并后的文本写入文件
new_output_file = "output/source/source1.txt"
new_output_file_simple = "output/source/source2.txt"

# custom定制 将合并后的文本写入文件
new_output_file_custom = "output/source/source3.txt"
