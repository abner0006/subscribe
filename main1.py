...
others_file = "output/other_channels.txt"

# NEW 将合并后的文本写入文件
new_output_file = "output/full_channels.txt"
new_output_file_simple = "output/simple_channels.txt"

# custom定制 将合并后的文本写入文件
new_output_file_custom = "output/custom_channels.txt"
